...
/* src/PNotify.html generated by Svelte v1.52.0 */
...
var methods = {
  ...
  initModule: function initModule(module) {
    ...
    module.fire("initModule", moduleOptions);
  ...
  position: function position() {
    ...
    var hidden = !elem.classList.contains("ui-pnotify-in") && !elem.classList.contains("ui-pnotify-initial-hidden");
    ...
    if (!hidden) {
      ...
      switch (stack.dir1) {
        case "down":
          ...
          break;
        case "up":
          curpos1 = (stack.context === document.body ? window.innerHeight : stack.context.scrollHeight) - elem.scrollHeight - elem.offsetTop;
          break;
        case "left":
          curpos1 = (stack.context === document.body ? window.innerWidth : stack.context.scrollWidth) - elem.scrollWidth - elem.offsetLeft;
          break;
        case "right":
      ...
      if (stack.dir2) {
        ...
        switch (stack.dir2) {
          case "down":
            ...
            break;
          case "up":
            curpos2 = (stack.context === document.body ? window.innerHeight : stack.context.scrollHeight) - elem.scrollHeight - elem.offsetTop;
            break;
          case "left":
            curpos2 = (stack.context === document.body ? window.innerWidth : stack.context.scrollWidth) - elem.scrollWidth - elem.offsetLeft;
            break;
          case "right":
        ...
        // Center the notice, because the stack has no dir2.
        ...
        switch (stack.dir1) {
          ...
          case "right":
            ...
            cssMiddle = stack.context.scrollHeight / 2 - elem.offsetHeight / 2;
            break;
        }
...
function oncreate() {
  ...
  this.on("mouseenter", function (e) {
    ...
    if (_this6.get("mouse_reset") && _this6.get("_animating") === "out") {
    ...
    if (_this6.get("hide") && _this6.get("mouse_reset")) {
      _this6.cancelRemove();
    }
  });
  ...
  this.on("mouseleave", function (e) {
    ...
    if (_this6.get("hide") && _this6.get("mouse_reset") && _this6.get("_animating") !== "out") {
      _this6.queueRemove();
    }
    PNotify.positionAll();
  });
...
function setup(Component) {
  ...
  // Remove all visible notices in a single stack.
...
function encapsulateStyles(node) {
  setAttribute(node, "svelte-3711985833", "");
}

function add_css() {
  var style = createElement("style");
  style.id = 'svelte-3711985833-style';
  style.textContent = "body>.ui-pnotify[svelte-3711985833]{position:fixed;z-index:100040}.ui-pnotify[svelte-3711985833]{top:36px;right:36px;position:absolute;height:auto;z-index:2;display:none}.ui-pnotify.ui-pnotify-in[svelte-3711985833]{display:block}.ui-pnotify.ui-pnotify-initial-hidden[svelte-3711985833]{display:block;visibility:hidden}.ui-pnotify.ui-pnotify-move[svelte-3711985833]{transition:left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-slow[svelte-3711985833]{transition:opacity .4s linear;opacity:0}.ui-pnotify.ui-pnotify-fade-slow.ui-pnotify.ui-pnotify-move[svelte-3711985833]{transition:opacity .4s linear, left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-normal[svelte-3711985833]{transition:opacity .25s linear;opacity:0}.ui-pnotify.ui-pnotify-fade-normal.ui-pnotify.ui-pnotify-move[svelte-3711985833]{transition:opacity .25s linear, left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-fast[svelte-3711985833]{transition:opacity .1s linear;opacity:0}.ui-pnotify.ui-pnotify-fade-fast.ui-pnotify.ui-pnotify-move[svelte-3711985833]{transition:opacity .1s linear, left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-in[svelte-3711985833]{opacity:1}.ui-pnotify[svelte-3711985833] .ui-pnotify-shadow[svelte-3711985833]{-webkit-box-shadow:0px 6px 28px 0px rgba(0,0,0,0.1);-moz-box-shadow:0px 6px 28px 0px rgba(0,0,0,0.1);box-shadow:0px 6px 28px 0px rgba(0,0,0,0.1)}.ui-pnotify-container[svelte-3711985833]{background-position:0 0;padding:.8em;height:100%;margin:0}.ui-pnotify-container[svelte-3711985833]:after{content:\" \";visibility:hidden;display:block;height:0;clear:both}.ui-pnotify-container.ui-pnotify-sharp[svelte-3711985833]{-webkit-border-radius:0;-moz-border-radius:0;border-radius:0}.ui-pnotify-title[svelte-3711985833]{display:block;margin-bottom:.4em;margin-top:0}.ui-pnotify-title-bs4[svelte-3711985833]{font-size:1.2rem}.ui-pnotify-text[svelte-3711985833]{display:block}.ui-pnotify-icon[svelte-3711985833],.ui-pnotify-icon[svelte-3711985833] span[svelte-3711985833]{display:block;float:left;margin-right:.2em}.ui-pnotify-icon-bs4[svelte-3711985833]{position:relative;top:5px}.ui-pnotify.stack-topleft[svelte-3711985833],.ui-pnotify.stack-bottomleft[svelte-3711985833]{left:25px;right:auto}.ui-pnotify.stack-bottomright[svelte-3711985833],.ui-pnotify.stack-bottomleft[svelte-3711985833]{bottom:25px;top:auto}.ui-pnotify-modal-overlay{background-color:rgba(0, 0, 0, .4);top:0;left:0;position:absolute;height:100%;width:100%;z-index:1}body>.ui-pnotify-modal-overlay{position:fixed;z-index:100039}.ui-pnotify-modal-overlay-hidden{display:none}";
...
function create_main_fragment(state, component) {
  ...
  function mousein_handler(event) {
    component.fire('mousein', event);
  }
  ...
  return {
    ...
    h: function hydrate() {
      ...
      encapsulateStyles(h4);
      h4.className = h4_class_value = "ui-pnotify-title " + state._styles.title;
      setStyle(h4, "display", state.title === false ? 'none' : 'block');
      encapsulateStyles(div_2);
      div_2.className = div_2_class_value = "ui-pnotify-text " + state._styles.text;
      ...
      div.className = div_class_value = "ui-pnotify " + state._styles.element + " " + state.addclass + " " + state._animatingClass + " " + state._moveClass + " " + (state.animation === 'fade' ? 'ui-pnotify-fade-' + state.animate_speed : '');
      setAttribute(div, "aria-live", "assertive");
      setAttribute(div, "role", "alertdialog");
      setAttribute(div, "ui-pnotify", true);
      addListener(div, "mousein", mousein_handler);
    ...
    p: function update(changed, state) {
      ...
      if (changed._styles && h4_class_value !== (h4_class_value = "ui-pnotify-title " + state._styles.title)) {
      ...
      if (changed._styles && div_2_class_value !== (div_2_class_value = "ui-pnotify-text " + state._styles.text)) {
      ...
      if ((changed.width || changed.min_height) && div_1_style_value !== (div_1_style_value = "\n        " + (typeof state.width === 'string' ? 'width: ' + state.width + ';' : '') + "\n        " + (typeof state.min_height === 'string' ? 'min-height: ' + state.min_height + ';' : '') + "\n      ")) {
        div_1.style.cssText = div_1_style_value;
      }

      if ((changed._styles || changed.addclass || changed._animatingClass || changed._moveClass || changed.animation || changed.animate_speed) && div_class_value !== (div_class_value = "ui-pnotify " + state._styles.element + " " + state.addclass + " " + state._animatingClass + " " + state._moveClass + " " + (state.animation === 'fade' ? 'ui-pnotify-fade-' + state.animate_speed : ''))) {
    ...
    d: function destroy() {
      ...
      removeListener(div, "mousein", mousein_handler);
...
// (34:4) {{#each _modulesPrependContainer as module}}
...
function create_if_block(state, component) {
  ...
  return {
    ...
    h: function hydrate() {
      ...
      span.className = span_class_value = state.icon === true ? state._icons[state.type] : state.icon;
      div.className = div_class_value = "ui-pnotify-icon " + state._styles.icon;
    },
    ...
    p: function update(changed, state) {
      if ((changed.icon || changed._icons || changed.type) && span_class_value !== (span_class_value = state.icon === true ? state._icons[state.type] : state.icon)) {
        span.className = span_class_value;
      }

      if (changed._styles && div_class_value !== (div_class_value = "ui-pnotify-icon " + state._styles.icon)) {
        div.className = div_class_value;
      }
    },
...
// (56:4) {{#each _modulesAppendContainer as module}}
...
function PNotify_1(options) {
  ...
  this._recompute({ text: 1, insert_brs: 1, styling: 1, icons: 1 }, this._state);

  if (!document.getElementById("svelte-3711985833-style")) add_css();
...
PNotify_1.prototype._recompute = function _recompute(changed, state) {
  ...
  if (changed.icons) {
    if (differs(state._icons, state._icons = _icons(state.icons))) changed._icons = true;
  }
};
