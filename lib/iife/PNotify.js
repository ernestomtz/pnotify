...
var PNotify = function () {
  ...
  function encapsulateStyles(node) {
    setAttribute(node, "svelte-1423343577", "");
  }

  function add_css() {
    var style = createElement("style");
    style.id = 'svelte-1423343577-style';
    style.textContent = "body>.ui-pnotify[svelte-1423343577]{position:fixed;z-index:100040}.ui-pnotify[svelte-1423343577]{position:absolute;height:auto;z-index:2;display:none}.ui-pnotify.ui-pnotify-in[svelte-1423343577]{display:block}.ui-pnotify.ui-pnotify-initial-hidden[svelte-1423343577]{display:block;visibility:hidden}.ui-pnotify.ui-pnotify-move[svelte-1423343577]{transition:left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-slow[svelte-1423343577]{transition:opacity .4s linear;opacity:0}.ui-pnotify.ui-pnotify-fade-slow.ui-pnotify.ui-pnotify-move[svelte-1423343577]{transition:opacity .4s linear, left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-normal[svelte-1423343577]{transition:opacity .25s linear;opacity:0}.ui-pnotify.ui-pnotify-fade-normal.ui-pnotify.ui-pnotify-move[svelte-1423343577]{transition:opacity .25s linear, left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-fast[svelte-1423343577]{transition:opacity .1s linear;opacity:0}.ui-pnotify.ui-pnotify-fade-fast.ui-pnotify.ui-pnotify-move[svelte-1423343577]{transition:opacity .1s linear, left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-in[svelte-1423343577]{opacity:1}.ui-pnotify[svelte-1423343577] .ui-pnotify-shadow[svelte-1423343577]{-webkit-box-shadow:0px 6px 28px 0px rgba(0,0,0,0.1);-moz-box-shadow:0px 6px 28px 0px rgba(0,0,0,0.1);box-shadow:0px 6px 28px 0px rgba(0,0,0,0.1)}.ui-pnotify-container[svelte-1423343577]{background-position:0 0;padding:.8em;height:100%;margin:0}.ui-pnotify-container[svelte-1423343577]:after{content:\" \";visibility:hidden;display:block;height:0;clear:both}.ui-pnotify-container.ui-pnotify-sharp[svelte-1423343577]{-webkit-border-radius:0;-moz-border-radius:0;border-radius:0}.ui-pnotify-title[svelte-1423343577]{display:block;white-space:pre-line;margin-bottom:.4em;margin-top:0}.ui-pnotify-title-bs4[svelte-1423343577]{font-size:1.2rem}.ui-pnotify-text[svelte-1423343577]{display:block;white-space:pre-line}.ui-pnotify-icon[svelte-1423343577],.ui-pnotify-icon[svelte-1423343577] span[svelte-1423343577]{display:block;float:left;margin-right:.2em}.ui-pnotify-icon-bs3[svelte-1423343577]>span[svelte-1423343577]{position:relative;top:2px}.ui-pnotify-icon-bs4[svelte-1423343577]>span[svelte-1423343577]{position:relative;top:4px}.ui-pnotify-modal-overlay{background-color:rgba(0, 0, 0, .4);top:0;left:0;position:absolute;height:100%;width:100%;z-index:1}body>.ui-pnotify-modal-overlay{position:fixed;z-index:100039}.ui-pnotify-modal-overlay-hidden{display:none}";
  ...
  function select_block_type(state) {
    if (state.trust_title) return create_if_block_1;
    return create_if_block_2;
  }

  function select_block_type_1(state) {
    if (state.trust_text) return create_if_block_3;
  ...
  function PNotify_1(options) {
    ...
    if (!document.getElementById("svelte-1423343577-style")) add_css();
