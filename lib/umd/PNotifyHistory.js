(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("PNotifyHistory", ["exports", "./PNotify.html"], factory);
  ...
  var methods = {
    beforeOpen: function beforeOpen() {
      var max_in_stack = this.get("max_in_stack");
      ...
      if (_PNotify2.default.notices && _PNotify2.default.notices.length > max_in_stack) {
