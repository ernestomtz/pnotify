(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("PNotifyAnimate", ["exports", "./PNotify.html"], factory);
  ...
  var methods = {
    ...
    setUpAnimations: function setUpAnimations() {
      ...
      if (this.get("animate")) {
        ...
        var animSpeed = 400;
        if (_options.animate_speed === "slow") {
          animSpeed = 600;
        } else if (_options.animate_speed === "fast") {
          animSpeed = 200;
        } else if (_options.animate_speed > 0) {
          animSpeed = _options.animate_speed;
        }
    ...
    animateIn: function animateIn(callback) {
      ...
      _notice.set({ "_animatingClass": "ui-pnotify-in animated " + this.get("in_class") });
    },
    animateOut: function animateOut(callback) {
      ...
      _notice.refs.elem.addEventListener('oanimationend', finished);
      _notice.refs.elem.addEventListener('animationend', finished);
      _notice.set({ "_animatingClass": "ui-pnotify-in animated " + this.get("out_class") });
    }
  };
