(function (global, factory) {
  ...
  function encapsulateStyles(node) {
    setAttribute(node, "svelte-3207146530", "");
  }

  function add_css() {
    var style = createElement("style");
    style.id = 'svelte-3207146530-style';
    style.textContent = "body>.ui-pnotify[svelte-3207146530]{position:fixed;z-index:100040}.ui-pnotify[svelte-3207146530]{position:absolute;height:auto;z-index:2;display:none}.ui-pnotify.ui-pnotify-in[svelte-3207146530]{display:block}.ui-pnotify.ui-pnotify-initial-hidden[svelte-3207146530]{display:block;visibility:hidden}.ui-pnotify.ui-pnotify-move[svelte-3207146530]{transition:left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-slow[svelte-3207146530]{transition:opacity .4s linear;opacity:0}.ui-pnotify.ui-pnotify-fade-slow.ui-pnotify.ui-pnotify-move[svelte-3207146530]{transition:opacity .4s linear, left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-normal[svelte-3207146530]{transition:opacity .25s linear;opacity:0}.ui-pnotify.ui-pnotify-fade-normal.ui-pnotify.ui-pnotify-move[svelte-3207146530]{transition:opacity .25s linear, left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-fast[svelte-3207146530]{transition:opacity .1s linear;opacity:0}.ui-pnotify.ui-pnotify-fade-fast.ui-pnotify.ui-pnotify-move[svelte-3207146530]{transition:opacity .1s linear, left .5s ease, top .5s ease, right .5s ease, bottom .5s ease}.ui-pnotify.ui-pnotify-fade-in[svelte-3207146530]{opacity:1}.ui-pnotify[svelte-3207146530] .ui-pnotify-shadow[svelte-3207146530]{-webkit-box-shadow:0px 6px 28px 0px rgba(0,0,0,0.1);-moz-box-shadow:0px 6px 28px 0px rgba(0,0,0,0.1);box-shadow:0px 6px 28px 0px rgba(0,0,0,0.1)}.ui-pnotify-container[svelte-3207146530]{background-position:0 0;padding:.8em;height:100%;margin:0}.ui-pnotify-container[svelte-3207146530]:after{content:\" \";visibility:hidden;display:block;height:0;clear:both}.ui-pnotify-container.ui-pnotify-sharp[svelte-3207146530]{-webkit-border-radius:0;-moz-border-radius:0;border-radius:0}.ui-pnotify-title[svelte-3207146530]{display:block;margin-bottom:.4em;margin-top:0}.ui-pnotify-title-bs4[svelte-3207146530]{font-size:1.2rem}.ui-pnotify-text[svelte-3207146530]{display:block}.ui-pnotify-icon[svelte-3207146530],.ui-pnotify-icon[svelte-3207146530] span[svelte-3207146530]{display:block;float:left;margin-right:.2em}.ui-pnotify-icon-bs3[svelte-3207146530]>span[svelte-3207146530]{position:relative;top:2px}.ui-pnotify-icon-bs4[svelte-3207146530]>span[svelte-3207146530]{position:relative;top:4px}.ui-pnotify-modal-overlay{background-color:rgba(0, 0, 0, .4);top:0;left:0;position:absolute;height:100%;width:100%;z-index:1}body>.ui-pnotify-modal-overlay{position:fixed;z-index:100039}.ui-pnotify-modal-overlay-hidden{display:none}";
  ...
  // (36:4) {{#each _modulesPrependContainer as module}}
  ...
  // (58:4) {{#each _modulesAppendContainer as module}}
  ...
  function PNotify_1(options) {
    ...
    if (!document.getElementById("svelte-3207146530-style")) add_css();
