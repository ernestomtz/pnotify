(function (global, factory) {
  ...
  function add_css() {
    ...
    style.id = 'svelte-2084218827-style';
  ...
  function create_main_fragment(state, component) {
    ...
    return {
      ...
      p: function update(changed, state) {
        ...
        if ((changed.icon || changed._styles || changed.addclass || changed._animatingClass || changed._moveClass || changed.animation || changed.animate_speed || changed.stack || changed._moduleClasses) && div_class_value !== (div_class_value = "\n      ui-pnotify\n      " + (state.icon !== false ? 'ui-pnotify-with-icon' : '') + "\n      " + (state._styles.element ? state._styles.element : '') + "\n      " + state.addclass + "\n      " + state._animatingClass + "\n      " + state._moveClass + "\n      " + (state.animation === 'fade' ? 'ui-pnotify-fade-' + state.animate_speed : '') + "\n      " + (state.stack && state.stack.modal ? 'ui-pnotify-modal' : '') + "\n      " + state._moduleClasses.join(' ') + "\n    ")) {
          div.className = div_class_value;
        }
      },
  ...
  function PNotify_1(options) {
    ...
    if (!document.getElementById("svelte-2084218827-style")) add_css();
