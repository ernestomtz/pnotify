(function (global, factory) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-4243777165", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-4243777165-style';
		style.textContent = ".ui-pnotify-reference-button[svelte-4243777165]{float:right}.ui-pnotify-reference-clearing[svelte-4243777165]{clear:right;line-height:0}";
	...
	function PNotifyReference(options) {
		...
		if (!document.getElementById("svelte-4243777165-style")) add_css();
