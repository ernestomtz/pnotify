(function (global, factory) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-3507944075", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-3507944075-style';
		style.textContent = ".ui-pnotify-reference-button[svelte-3507944075]{float:right}.ui-pnotify-reference-clearing[svelte-3507944075]{clear:right;line-height:0}";
	...
	function PNotifyReference(options) {
		...
		if (!document.getElementById("svelte-3507944075-style")) add_css();
