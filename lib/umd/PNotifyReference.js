(function (global, factory) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-2659373170", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-2659373170-style';
		style.textContent = ".ui-pnotify-reference-button[svelte-2659373170]{float:right}.ui-pnotify-reference-clearing[svelte-2659373170]{clear:right;line-height:0}";
	...
	function PNotifyReference(options) {
		...
		if (!document.getElementById("svelte-2659373170-style")) add_css();
