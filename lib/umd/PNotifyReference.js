(function (global, factory) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-582116192", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-582116192-style';
		style.textContent = ".ui-pnotify-reference-button[svelte-582116192]{float:right}.ui-pnotify-reference-clearing[svelte-582116192]{clear:right;line-height:0}";
	...
	function PNotifyReference(options) {
		...
		if (!document.getElementById("svelte-582116192-style")) add_css();
