(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define("PNotifyConfirm", ["exports", "./PNotify.html"], factory);
	...
	function create_if_block_2(state, component) {
		...
		return {
			...
			h: function hydrate() {
				...
				setStyle(textarea, "margin-bottom", "5px");
				setStyle(textarea, "clear", "both");
	...
	function create_if_block_3(state, component) {
		...
		return {
			...
			h: function hydrate() {
				...
				setStyle(input, "margin-bottom", "5px");
				setStyle(input, "clear", "both");
	...
	function create_each_block(state, buttons, button, button_index, component) {
		...
		return {
			...
			p: function update(changed, state, buttons, button, button_index) {
				...
				if ((changed._notice || changed.buttons) && button_1_class_value !== (button_1_class_value = "\n            ui-pnotify-action-button\n            " + (state._notice.get('_styles').btn ? state._notice.get('_styles').btn : '') + "\n            " + (button.addClass ? button.addClass : '') + "\n          ")) {
					button_1.className = button_1_class_value;
				}
	...
	function create_if_block(state, component) {
		...
		return {
			...
			h: function hydrate() {
				div.className = div_class_value = "ui-pnotify-action-bar " + (state._notice.get('_styles').text ? state._notice.get('_styles').text : '');
			...
			p: function update(changed, state) {
				...
				if (changed._notice && div_class_value !== (div_class_value = "ui-pnotify-action-bar " + (state._notice.get('_styles').text ? state._notice.get('_styles').text : ''))) {
