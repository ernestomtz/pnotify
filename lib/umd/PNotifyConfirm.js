(function (global, factory) {
	...
	function setup(Component) {
		...
		_extends(_PNotify2.default.styling.bootstrap3, {
			...
			prompt_bar: "ui-pnotify-confirm-ml",
			btn: "btn btn-default ui-pnotify-confirm-mx-1",
			btn_primary: "btn btn-default ui-pnotify-confirm-mx-1 btn-primary",
			input: "form-control"
		});
		_extends(_PNotify2.default.styling.bootstrap4, {
			...
			btn_primary: "btn btn-primary mx-1",
			input: "form-control"
		});
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-2648226822", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-2648226822-style';
		style.textContent = ".ui-pnotify-action-bar[svelte-2648226822],.ui-pnotify-prompt-bar[svelte-2648226822]{margin-top:5px;clear:both}.ui-pnotify-action-bar[svelte-2648226822]{display:flex;flex-wrap:wrap;justify-content:flex-end}.ui-pnotify-prompt-input[svelte-2648226822]{margin-bottom:5px;display:block;width:100%}.ui-pnotify-confirm-mx-1[svelte-2648226822]{margin:0 5px}.ui-pnotify.ui-pnotify-with-icon .ui-pnotify-confirm-ml{margin-left:24px}[dir=rtl] .ui-pnotify.ui-pnotify-with-icon .ui-pnotify-confirm-ml{margin-right:24px;margin-left:0}";
	...
	function create_if_block_1(state, component) {
		...
		return {
			...
			h: function hydrate() {
				...
				div.className = div_class_value = "\n            ui-pnotify-prompt-bar\n            " + (state._notice.get('_styles').prompt_bar ? state._notice.get('_styles').prompt_bar : '') + "\n            " + (state._notice.get('_styles').text ? state._notice.get('_styles').text : '') + "\n          ";
			},
	...
	function PNotifyConfirm(options) {
		...
		if (!document.getElementById("svelte-2648226822-style")) add_css();
