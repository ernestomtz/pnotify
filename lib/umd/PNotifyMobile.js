(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("PNotifyMobile", ["exports", "./PNotify.html"], factory);
  ...
  var methods = {
    ...
    doMobileStyling: function doMobileStyling() {
      ...
      if (this.get("styling")) {
        ...
        notice.removeModuleClass("ui-pnotify-mobile-able");
        notice.removeModuleClass("ui-pnotify-mobile-top");
        notice.removeModuleClass("ui-pnotify-mobile-bottom");
        notice.removeModuleClass("ui-pnotify-mobile-right");
        notice.removeModuleClass("ui-pnotify-mobile-left");
  ...
  function oncreate() {
    ...
    this.on("initModule", function (options) {
      ...
      notice.on("touchmove", function (e) {
        if (!origXY || !_this.get("swipe_dismiss")) {
          return;
        }
  ...
  function add_css() {
    ...
    style.id = 'svelte-802806721-style';
    style.textContent = "[ui-pnotify] .ui-pnotify-container{position:relative}[ui-pnotify] .ui-pnotify-mobile-animate-left{transition:left .1s ease}[ui-pnotify] .ui-pnotify-mobile-animate-top{transition:top .1s ease}@media(max-width: 480px){[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify{font-size:1.2em;-webkit-font-smoothing:antialiased;-moz-font-smoothing:antialiased;-ms-font-smoothing:antialiased;font-smoothing:antialiased}body > [ui-pnotify].ui-pnotify-mobile-able.ui-pnotify{position:fixed}[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-top.ui-pnotify,[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-bottom.ui-pnotify{width:100% !important}[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-left.ui-pnotify,[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-right.ui-pnotify{height:100% !important}[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify .ui-pnotify-shadow{-webkit-box-shadow:none;-moz-box-shadow:none;box-shadow:none}[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-top.ui-pnotify .ui-pnotify-shadow{border-bottom-width:5px}[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-bottom.ui-pnotify .ui-pnotify-shadow{border-top-width:5px}[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-left.ui-pnotify .ui-pnotify-shadow{border-right-width:5px}[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-right.ui-pnotify .ui-pnotify-shadow{border-left-width:5px}[ui-pnotify].ui-pnotify-mobile-able .ui-pnotify-container{-webkit-border-radius:0;-moz-border-radius:0;border-radius:0}[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-top .ui-pnotify-container,[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-bottom .ui-pnotify-container{width:auto !important}[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-left .ui-pnotify-container,[ui-pnotify].ui-pnotify-mobile-able.ui-pnotify-mobile-right .ui-pnotify-container{height:100% !important}}";
  ...
  function PNotifyMobile(options) {
    ...
    if (!document.getElementById("svelte-802806721-style")) add_css();
