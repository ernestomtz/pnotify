(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define("PNotifyButtons", ["exports", "./PNotify.html"], factory);
	...
	function _pin_up_class(classes, _notice) {
		return _notice ? classes.pin_up === null ? _notice.get("_styles").pin_up : classes.pin_up : '';
	}

	function _pin_down_class(classes, _notice) {
		return _notice ? classes.pin_down === null ? _notice.get("_styles").pin_down : classes.pin_down : '';
	}

	function _closer_class(classes, _notice) {
		return _notice ? classes.closer === null ? _notice.get("_styles").closer : classes.closer : '';
	}
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-4122122283", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-4122122283-style';
		style.textContent = ".ui-pnotify-closer[svelte-4122122283],.ui-pnotify-sticker[svelte-4122122283]{float:right;margin-left:.5em;cursor:pointer}.ui-pnotify-hidden[svelte-4122122283]{visibility:hidden}";
	...
	function PNotifyButtons(options) {
		...
		if (!document.getElementById("svelte-4122122283-style")) add_css();
