(function (global, factory) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-2196029209", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-2196029209-style';
		style.textContent = ".ui-pnotify-closer[svelte-2196029209],.ui-pnotify-sticker[svelte-2196029209]{float:right;margin-left:.5em;cursor:pointer}.ui-pnotify-hidden[svelte-2196029209]{visibility:hidden}";
	...
	function PNotifyButtons(options) {
		...
		if (!document.getElementById("svelte-2196029209-style")) add_css();
