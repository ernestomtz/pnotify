(function (global, factory) {
	...
	function oncreate() {
		...
		this.on("initModule", function (options) {
			...
			_this.get("_notice").observe("hide", function (hide) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-3983608287", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-3983608287-style';
		style.textContent = ".ui-pnotify-closer[svelte-3983608287],.ui-pnotify-sticker[svelte-3983608287]{float:right;margin-left:.5em;cursor:pointer}.ui-pnotify-hidden[svelte-3983608287]{visibility:hidden}";
	...
	function PNotifyButtons(options) {
		...
		if (!document.getElementById("svelte-3983608287-style")) add_css();
