(function (global, factory) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-701458202", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-701458202-style';
		style.textContent = ".ui-pnotify-closer[svelte-701458202],.ui-pnotify-sticker[svelte-701458202]{float:right;margin-left:.5em;cursor:pointer}.ui-pnotify-hidden[svelte-701458202]{visibility:hidden}";
	...
	function PNotifyButtons(options) {
		...
		if (!document.getElementById("svelte-701458202-style")) add_css();
