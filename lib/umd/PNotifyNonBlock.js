(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("PNotifyNonBlock", ["exports", "./PNotify.html"], factory);
  ...
  function add_css() {
    ...
    style.id = 'svelte-2150265124-style';
  ...
  function PNotifyNonBlock(options) {
    ...
    if (!document.getElementById("svelte-2150265124-style")) add_css();
